...
```
## Overview
This is a brief report regarding internet redlining for internet services provided by AT&T specifically based on data from a study conducted by _The MarkUp_. This report explores relationships between different socio-economic disparities such as race and household income with speed and price of internet services. 
...
`r Max_upload_speed_ATT`. The lowest speed of internet service provided in non-white areas by AT&T was `r locations_with_lowest_Redling_Grade_ATT`. 

Here are the locations which experienced the lowest internet redlining by AT&T `r locations_with_lowest_Redling_Grade_ATT`. 
