...
## Introduction
For this project we plan on exploring the relationship between internet service speed and prices in different areas across the United States, and how different internet service providers redline certain areas to essentially price-gouge lower income areas. We are utilizing data discovered on [kaggle](https://www.kaggle.com/datasets). The data compares
## Problem Domain
Background: 
