  ...
  navbarPage("Internet Information", 
             ...
             tabPanel("Report Page",
                      sidebarLayout(
                        ...
                        mainPanel(
                          h2("Code name"),
                          p("AT&T Internet Service Analysis"),
                          h2("Project title"),
                          p("Inequality presented in different social classes based on internet services."),
                          h2("Members"),
                          p("Neha Venkatesh, ", em("nehav22@uw.edu"),", 
                          ...
                          h2("Keywords"),
                          p("IInternet, Redlining, Income distributions, Regression, Exploratory data analysis"),
                          h2("Introduction"),
